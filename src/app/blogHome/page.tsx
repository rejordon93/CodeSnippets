  ...
  return (
    <div className="max-w-5xl mx-auto p-4 space-y-6">
      {snippets.map((snippet) => (
        <div
          key={snippet.id}
          className="bg-white dark:bg-gray-900 rounded-lg shadow-md p-6 border border-gray-200 dark:border-gray-800 transition hover:shadow-lg"
        >
          {/* Header */}
          ...
          <div className="flex flex-wrap gap-2 mb-4">
            {snippet.tags.map((tag, index) => (
              <span
                key={index}
                className="bg-gray-200 dark:bg-gray-700 text-xs text-gray-700 dark:text-gray-300 px-2 py-1 rounded-full"
              >
                #{tag}
              </span>
            ))}
